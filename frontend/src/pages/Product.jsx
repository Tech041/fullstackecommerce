      ...
      <div className="mt-20 ">
        ...
        <div className="flex flex-col gap-4 border px-6 text-sm text-gray-500">
          <p className="">
            ...
            to showcase and sell products or services to customers digitally. It
            includes features like product catalogs, shopping carts, secure
            payment gateways, user accounts, and order tracking.
          </p>
          <p className="">
            {" "}
            Designed for accessibility and convenience, e-commerce websites
            allow seamless transactions and a personalized shopping experience,
            making them a vital tool for modern businesses.
          </p>
        </div>
      </div>
