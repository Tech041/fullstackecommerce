      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p className="">
            ...
            pharmaceuticals, ensuring you receive genuine, high-quality products
          ...
          <p className="">
            ...
            Supplements – Support your well-being with premium health products.
            <br /> ✅ Personal Care & Wellness – Everything from skincare to
            medical devices.
          </p>
          <b className="text-purple-700">Our Mission</b>
          <p className="">
          At Nelpharma, our mission is to make healthcare accessible, affordable, and convenient for everyone. We are committed to providing high-quality, safe, and effective medications while ensuring a seamless online shopping experience.
          </p>
        </div>
      </div>
